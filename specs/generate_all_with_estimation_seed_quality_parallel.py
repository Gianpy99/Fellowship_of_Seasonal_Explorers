...
DEFAULT_SHARPNESS_THRESHOLD = 10.0  # default consigliato per stile Ghibli/Disney/Tolkien
...
def generate_image(pipe, prompt, filename, size, category, generator, executor):
    """Generazione GPU + delega salvataggio/quality-check al thread pool."""
...
def main():
    ...
    # CLI: --resume, --preview, --min-sharpness=12.0, <num_variants>, <product_filter>
    for arg in args:
        if arg.isdigit():
    ...
    # Resume: carica mapping se presente
    mapping = {}
    ...
    with ThreadPoolExecutor(max_workers=2) as executor:
        ...
        # Attende il completamento dei thread di salvataggio/quality-check
